...
<?php
session_start();
include 'airlinesdb.php';



$products = [
  1 => ['name' => 'FRANCE', 'price' => 4999, 'category' => 'adults'],
  2 => ['name' => 'ITALY', 'price' => 2999, 'category' => 'teens'],
  3 => ['name' => 'GERMANY', 'price' => 999, 'category' => 'kids'],
  4 => ['name' => 'SPAIN', 'price' => 3999, 'category' => 'adults'],
  5 => ['name' => 'MEXICO', 'price' => 2999, 'category' => 'teens'],
  6 => ['name' => 'UNITED KINGDOM', 'price' => 799, 'category' => 'kids'],
  7 => ['name' => 'UNITED STATES', 'price' => 3999, 'category' => 'adults'],
  8 => ['name' => 'TURKEY', 'price' => 1999, 'category' => 'teens'],
  9 => ['name' => 'THAILAND', 'price' => 699, 'category' => 'kids'],
  10 => ['name' => 'CHINA', 'price' => 4999, 'category' => 'adults', 'image' => 'threadlinejpg/adultblazer.jpg'],
];
...
<div class="navbar">
  <div class="nav-group">
    <?php if (!empty($_SESSION['logged_in'])): ?>
      <button onclick="location.href='?category=adults'">Black Belt</button>
      <button onclick="location.href='?category=teens'">Red Belt</button>
      <button onclick="location.href='?category=kids'">White Belt</button>
    <?php endif; ?>
  </div>
  <div class="logo" onclick="location.href='?'">AIRLINES</div>
  <div class="nav-group">
    <?php if (!empty($_SESSION['logged_in'])): ?>
